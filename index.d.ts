declare namespace VK {
    ...
    export namespace Objects {
        ...
        export interface Topic {
            ...
            updated_by: number;
            /**
             * информация о том, закрыто ли обсуждение. Возможные значения: 0 — не закрыто; 1 — закрыто. 
             */
            is_closed: number;
            /**
             * информация о том, закреплено ли обсуждение наверху списка. Возможные значения: 0 — не закреплено; 1 — закреплено. 
             */
            is_fixed: number;
            /**
        ...
        export interface CommentBoard {
             ...
             */
            likes: CommentBoardLikesInfo;
        }

        /**
         * информация об отметках «Мне нравится» текущего комментария (если был задан параметр need_likes)
         */
        export interface CommentBoardLikesInfo {
            /**
        ...
        export interface App {
            ...
            banner_1120: string;
            /**
             * тип приложения. Возможные значения: app — социальное приложение; game — игра; site — подключаемый сайт; standalone — отдельное приложение (для мобильного устройства).
             */
            type: AppType;
            /**
            ...
            /**
             * тип турнирной таблицы. Возможные значения: 0 — не поддерживается; 1 — по уровню; 2 — по очкам.
             */
            ...
            /**
             * доступно ли приложение в мобильном каталоге. Возможные значения: 1 — доступно; 0 — недоступно.
             */
            friends: number[];
            /**
            ...
            is_html5_app: number;
            /**
             * поддерживаемая ориентация экрана. Возможные значения: 0 — альбомная и портретная; 1 — только альбомная; 2 — только портретная.
             */
        ...
        //#region Медиаконтент и вложения
         ...
         */
        export type PhotoSizeType = 's' | 'm' | 'x' | 'o' | 'p' | 'q' | 'r' | 'y' | 'z' | 'w';
         ...
         * w — пропорциональная копия изображения с максимальным размером 2560x2048px.
         */
        export type DocumentSizeType = 's' | 'm' | 'x' | 'o' | 'p' | 'q' | 'r' | 'y' | 'z' | 'w';
